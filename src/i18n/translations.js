export const translations = {
  fr: {
    ...
    therapeuticExpertise: {
      ...
      heroSubtitle: "Oncologie, SNC, maladies rares, en France et à l'international.",
      studyTypesTitle: "Types d'études",
      studyTypesIntro: "Quatre modalités d'accompagnement adaptées à votre stade de développement.",
      perimetersTitle: "Périmètres d'études",
      areasTitle: "Aires thérapeutiques couvertes",
      areasIntro: "L'ensemble des aires où nous avons accompagné nos partenaires.",
